...
class IntegrationRepository extends BaseRepository
{
     ...
     * @return      Integration[]|LengthAwarePaginator
     */
    ...
    {
        $qb->from('App\Models\Integrations\Integration', 'integration');

        if (!is_null(AU::get($query['ids'])))
            $qb->andWhere($qb->expr()->in('integration.id', $query['ids']));


        $qb->orderBy('integration.id', 'ASC');
        return $qb;
    }
