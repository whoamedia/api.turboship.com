...
use App\Services\Shopify\Models\Responses\ProductImage;
use App\Services\Shopify\Models\Responses\ProductOption;
    ...
    public function __construct($data = [])
    {
        ...
        if (AU::isArrays($options))
        {
            foreach ($options AS $item)
                $this->options[]        = new ProductOption($item);
        }
        ...
        {
            $this->images[]             = new ProductImage($item);
        }
    }
